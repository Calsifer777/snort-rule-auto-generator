...
if __name__ == '__main__':
    ...
    cluster_set = data['cluster_id'].unique()
    cluster_max  = data["cluster_id"].max(0)
    ...
    output_name = f"{day}_ssh_cluster_mul"
    ...
    with open(f"generate_file_test/{output_name}_snort.rules.txt", "w") as f: # save all cluster snort rule as a file
